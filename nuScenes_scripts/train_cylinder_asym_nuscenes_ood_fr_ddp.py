...
def main(args):
    ...
    global_train_batch_size = train_dataloader_config['batch_size']
    global_val_batch_size = val_dataloader_config['batch_size']

    assert global_train_batch_size % world_size == 0, "Train batch size must be divisible by world size"
    assert global_val_batch_size % world_size == 0, "Val batch size must be divisible by world size"

    per_gpu_train_batch_size = global_train_batch_size // world_size
    per_gpu_val_batch_size = global_val_batch_size // world_size

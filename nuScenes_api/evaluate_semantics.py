...
if __name__ == '__main__':
  ...
  pred_names = []
  pred_paths = os.path.join(FLAGS.predictions, "CSS_results","sequences", "08", "predictions")
  ...
  scores_names = []
  scores_paths = os.path.join(FLAGS.predictions, "AnomalyDetection_results","sequences", "08", "predictions")
  # populate the label names

...
def main(args):
    ...
    while epoch < train_hypers['max_num_epochs']:
        ...
        for i_iter, (_, train_vox_label, train_grid, _, train_pt_fea) in enumerate(train_dataset_loader):
            ...
            coor_ori, y_in_normal, y_out_arcface = my_model(train_pt_fea_ten, train_vox_ten, train_batch_size)
        ...
        with torch.no_grad():
            ...
            for i_iter_val, (_, val_vox_label, val_grid, val_pt_labs, val_pt_fea, idx) in enumerate(
                ...
                coor_ori, y_in_normal, y_out_arcface = my_model(val_pt_fea_ten, val_grid_ten, val_batch_size)
                ...
                loss_val = 1.0 * val_loss_sem + 0.5 * val_loss_obj + 0.5 * val_loss_arcface
